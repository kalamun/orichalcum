...
if(isset($_GET['iduser'])) {
	...
	<div class="subset">
		<fieldset class="box"><legend><?= $kaTranslate->translate('Users:Profile Picture'); ?></legend>
			<div id="featuredImageContainer"><?php 				if($u['featuredimage']>0)
				{
...
elseif(isset($_GET['password'])) {
	...
	<div class="topset">
		...
		<table class="tabella">
		<tr><th><?= $kaTranslate->translate('Users:User'); ?></th><th><?= $kaTranslate->translate('Users:Username'); ?></th><th><?= $kaTranslate->translate('Users:Created on'); ?> / <?= $kaTranslate->translate('Users:Last log-in'); ?></th></tr><?php 		foreach($kaUsers->getUsersList() as $ka=>$v) { ?>
			<tr>
