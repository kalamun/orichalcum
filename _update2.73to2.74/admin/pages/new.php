...
?><h1><?= $kaTranslate->translate(PAGE_NAME); ?></h1>
	...
	<div class="URLBox"><?= b3_create_input("dir","text",$kaTranslate->translate('Pages:Page URL').": ".BASEDIR.strtolower($_SESSION['ll'])."/",(isset($copyfrom['dir'])?$copyfrom['dir'].'-'.date("Ymd"):''),"400px",128,'onkeyup="checkURL(this)"'); ?> <span id="dirYetExists" style="display:none;"><?= $kaTranslate->translate('Pages:This URL already exists'); ?>!</span></div><br />
