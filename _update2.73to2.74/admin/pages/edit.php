...
/*********************************************/
	...
	*/
	...
	<div class="topset">
		...
		<div class="URLBox">
			<?= b3_create_input("dir","text",$kaTranslate->translate('Pages:Page URL').": ".BASEDIR.strtolower($_SESSION['ll'])."/",b3_lmthize($page['dir'],"input"),"400px",128,'onkeyup="checkURL(this)"'); ?>
