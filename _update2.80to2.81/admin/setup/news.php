...
<form action="?" method="post" onsubmit="return ableAllFields(this)">
	...
	<tr>
		...
		<td><?php 
			$option=array("data DESC","data ASC","pubblica DESC","pubblica ASC","starting_date DESC","starting_date ASC","scadenza DESC","scadenza ASC");
			$value=array("Data di inserimento discendente","Data di inserimento ascendente",
			             "Data di pubblicazione discendente","Data di pubblicazione ascendente",
			             "Data di inizio discendente","Data di inizio ascendente",
			             "Data di scadenza discendente","Data di scadenza ascendente");
