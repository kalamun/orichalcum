		...
		<div class="title">
			...
			<div style="width:48%;float:left;">
				...
				<select name="permissions" onchange="swapMembersListVisualization(this,'membersList');">
					...
					<? if(isset($allowedpermissions['public'])) { ?><option value="public" selected><?= $kaTranslate->translate('Private:Anyone can access'); ?></option><? } ?>
					<? if(isset($allowedpermissions['members'])) { ?><option value="members"><?= $kaTranslate->translate('Private:All members can access'); ?></option><? } ?>
					<? if(isset($allowedpermissions['restricted'])) { ?><option value="restricted"><?= $kaTranslate->translate('Private:Only specified members can access'); ?></option><? } ?>
					<? if(isset($allowedpermissions['private'])) { ?><option value="private"><?= $kaTranslate->translate('Private:Nobody can access'); ?></option><? } ?>
					</select><br />
				<br />
