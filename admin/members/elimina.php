...
<br />
	...
	<div class="topset">
		...
		<table class="tabella">
		<tr><th>&nbsp;</th><th>Utente</th><th>Username</th><th>Creato</th><th>Ultimo Accesso</th><th>Scadenza</th></tr><?php 		foreach($kaMembers->getUsersList() as $ka=>$v) {
			if($v['status']=="del") {
				echo '<tr>';
				echo '<td><img src="img/'.$v['status'].'.png" width="16" height="16" /></td>';
