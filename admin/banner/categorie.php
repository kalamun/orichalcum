		...
		<?
			...
			foreach($categorie as $cat) {
				?><tr>
					...
					<small class="actions"><a href="?idcat=<? echo $cat['idcat']; ?>">Modifica</a> | <a href="?delete=<? echo $cat['idcat']; ?>" onclick="return confirm('Sei sicuro di voler rimuovere questa categoria?');">Elimina</a></small>
