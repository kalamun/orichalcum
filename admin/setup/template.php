...
if(isset($_GET['tpl'])) {
	...
	if(is_dir(BASERELDIR.DIR_TEMPLATE.$_GET['tpl'])&&trim($_GET['tpl'],".")!="") {
		?>
		<div class="subset"><h2><?= $kaTranslate->translate('Setup:Files'); ?></h2><?
		...
		<div class="topset">
			...
			<textarea id="HTMLeditor" wrap="off" name="contents"><?
...
/**************************************/
	...
	<div class="topset">
		...
		<table class="tabella">
		<tr><th>Template</th><th></th></tr><?php
