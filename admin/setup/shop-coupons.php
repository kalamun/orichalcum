...
if(!isset($_GET['idscoup'])) {
	...
	while($row=ksql_Fetch_array($results)) {
		...
		<td class="actions">
			<a href="?idscoup=<?php  echo $row['idscoup']; ?>" class="smallbutton">Modifica</a>
			<a href="?delete=<?php  echo $row['idscoup']; ?>" class="smallalertbutton" onclick="return confirm('Sei sicuro di voler rimuovere questo corriere?');">Elimina</a>
			</td>
		</tr>
		<?php  }
	?>
