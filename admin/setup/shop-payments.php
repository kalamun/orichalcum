...
if(!isset($_GET['idspay'])) {
	...
	while($row=mysql_Fetch_array($results)) { ?>
		...
		<div class="small" style="visibility:hidden;float:right;"><a href="?idspay=<? echo $row['idspay']; ?>">Modifica</a> | <a href="?delete=<? echo $row['idspay']; ?>" onclick="return confirm('Sei sicuro di voler rimuovere questo corriere?');">Elimina</a></div>
		<?= $row['name']; ?>
