...
<div class="page-header">
	<div class="row">
		<div class="grid w12">
			<h1>Elimina un amministratore</h1>
		</div>
	</div>
</div>
...
<div class="page-container">
	...
	<form action="?user_id=<?= intval($_GET['user_id']); ?>" method="post">
		...
		<?= ok_input( [ "type" => "hidden", "name" => "nonce", "value" => ok_create_nonce( "delete-admin-user" ) ] ); ?>
		...
		<div class="row margin-top-60">
			<div class="submit">
				<?= ok_input( [ "type" => "submit", "name" => "delete-admin-user", "value" => "Elimina l’utente", "class" => "alert" ] ); ?><br>
				<br>
