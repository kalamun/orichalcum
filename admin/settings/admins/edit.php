...
<div class="page-header">
	<div class="row">
		<div class="grid w12">
			<h1>Modifica un amministratore</h1>
		</div>
	</div>
</div>
...
<div class="page-container">
	...
	<form action="?user_id=<?= intval($_GET['user_id']); ?>" method="post">
		...
		<?= ok_input( [ "type" => "hidden", "name" => "nonce", "value" => ok_create_nonce( "edit-admin-user" ) ] ); ?>
		...
		<div class="row margin-top-60">
			<div class="submit">
				<?= ok_input( [ "type" => "submit", "name" => "edit-admin-user", "value" => "Salva le modifiche" ] ); ?><br>
				<br>
