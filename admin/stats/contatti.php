<?php
define("PAGE_NAME","Statistiche &gt; Contatti");
...
foreach($giorno as $ka=>$v) {
	?><tr><th class="d<?= $ka; ?>"><?= $v; ?></th><td><div class="statWeekDay" style="width:<?= $stats['contatti']['d'.$ka]*$avgwidth; ?>px;"><?= $stats['contatti']['d'.$ka]; ?></div></td></tr><?
	}
	?>
</table>
...
for($i=0;$i<=23;$i++) {
	?><tr><th><?= $i; ?>:00</th><td><div class="statWeekDay" style="width:<?= $stats['contatti']['h'.$i]*$avgwidth; ?>px;"><?= $stats['contatti']['h'.$i]; ?></div></td></tr><?
	}
	?>
</table>
