<?php
define("PAGE_NAME","Statistiche &gt; Visitatori");
...
foreach($giorno as $ka=>$v) {
	?><tr><th class="d<?= $ka; ?>"><?= $v; ?></th><td><div class="statWeekDay" style="width:<?= $stats['visite']['d'.$ka]*$avgwidth; ?>px;"><?= $stats['visite']['d'.$ka]; ?></div></td></tr><?
	}
	?>
</table>
...
for($i=0;$i<=23;$i++) {
	?><tr><th><?= $i; ?>:00</th><td><div class="statWeekDay" style="width:<?= $stats['visite']['h'.$i]*$avgwidth; ?>px;"><?= $stats['visite']['h'.$i]; ?></div></td></tr><?
	}
	?>
</table>
