	...
	if($log=="") {
		...
		if(isset($_POST['copyNews'])) {
			...
			while($r=ksql_fetch_array($rs)) {
				...
				$r2=ksql_fetch_array($rs2);
				if($r2==false) {
					$q="INSERT INTO ".TABLE_CATEGORIE." (tabella,categoria,dir,ordine,ll) VALUES('".TABLE_NEWS."','".ksql_real_escape_string($r['categoria'])."','".ksql_real_escape_string($r['dir'])."','".$r['ordine']."','".$_POST['destinationLang']."')";
					if(ksql_query($q)) $catMap[$r['idcat']]=ksql_insert_id();
					}
				else $catMap[$r['idcat']]=$r2['idcat'];
				}
		...
		if(isset($_POST['copyShop'])) {
			...
			while($r=ksql_fetch_array($rs)) {
				...
				$r2=ksql_fetch_array($rs2);
				if($r2==false) {
					$q="INSERT INTO ".TABLE_CATEGORIE." (tabella,categoria,dir,ordine,ll) VALUES('".TABLE_SHOP_ITEMS."','".ksql_real_escape_string($r['categoria'])."','".ksql_real_escape_string($r['dir'])."','".$r['ordine']."','".$_POST['destinationLang']."')";
					if(ksql_query($q)) $catMap[$r['idcat']]=ksql_insert_id();
					}
				else $catMap[$r['idcat']]=$r2['idcat'];
				}
		...
		if(isset($_POST['copyBanners'])) {
			...
			while($r=ksql_fetch_array($rs)) {
				...
				$r2=ksql_fetch_array($rs2);
				if($r2==false) {
					$q="INSERT INTO ".TABLE_CATEGORIE." (tabella,categoria,dir,ordine,ll) VALUES('".TABLE_BANNER."','".ksql_real_escape_string($r['categoria'])."','".ksql_real_escape_string($r['dir'])."','".$r['ordine']."','".$_POST['destinationLang']."')";
					if(ksql_query($q)) $catMap[$r['idcat']]=ksql_insert_id();
					}
				else $catMap[$r['idcat']]=$r2['idcat'];
				}
